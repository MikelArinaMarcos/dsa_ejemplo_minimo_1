...
public class Main {
    ...
    public static HttpServer startServer() {
        final ResourceConfig rc = new ResourceConfig().packages("edu.upc.eeta.dsa.services");
        ...
        beanConfig.setContact("mikel.arina@estudiantat.upc.edu");
        beanConfig.setDescription("REST API para el Mínimo 1 de ejemplo de DSA");
